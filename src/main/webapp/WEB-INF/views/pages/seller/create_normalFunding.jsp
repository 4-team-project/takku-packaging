									...
									success : function(productList) {
										...
										if (selectedId) {
											...
											history.replaceState({},
													document.title,
													window.location.pathname); // 파라미터 제거
										}
									}
								});
										...
										function() {
											...
											if (productId) {
												const redirectUrl = encodeURIComponent(window.location.pathname
														+ '?type=general&selectedProductId='
														+ productId);
...
<form
	...
	<div class="menuName">
		...
		<div class="menu-select">
			...
			onclick="location.href='${cpath}/seller/product/new?storeId=${storeDTO.storeId}&redirectUrl=${cpath}/seller/fundings/create-step2?type=general'">
				메뉴	추가</button>
	...
	<div class="menuPrice">
		...
		<input type="number" id="menuPrice" placeholder="판매가 "
			name="salePrice" required class="form-input" /> <span
			class="unit-text">&nbsp;원</span><br> <span id="discountRate">할인율은
			%입니다.</span>
	</div>
	...
	<div class="form-group">
		...
		<input type="number" id="minSales" name="targetQty"
			...
			class="unit-text">&nbsp;개</span><br> <span id="minPrice">펀딩
	...
	<div class="form-group">
		...
		<div class="description">예: 50개가 가능하면, 50개 판매시 사용자가 펀딩 참여
			불가능합니다.</div>
